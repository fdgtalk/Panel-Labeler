import { ArrowRight, Bath, BedDouble, Car, ChartNoAxesColumnIncreasing, ChevronDown, ChevronUp, Download, Dumbbell, Fan, Hammer, Lightbulb, ListOrdered, Minus, Moon, MousePointer2, PanelTop, Plug, Printer, RotateCcw, Settings2, Sofa, Sun, Trees, Trash2, Triangle, Upload, Utensils, WashingMachine, Waves, Wrench } from 'lucide-react'
...
Object.assign(iconMap,{Atelier:Hammer,'Salle de lavage':WashingMachine,Cuisine:Utensils,Chambre:BedDouble,'Garçonnière':BedDouble,'Salle de bain':Bath,Bureau:Wrench,Escalier:ChartNoAxesColumnIncreasing,Salon:Sofa,'Salle à manger':Utensils,Garage:Car,Terrasse:Trees,'Extérieur':Trees,'Mécanique':Wrench})
